...
class mark_regression_view(ctk.CTkToplevel):
    def __init__(self):
        ...
        # data_mark_regression[const.DATA_LENGTH+2][0]='Ошибка апроксимации'
        # data_mark_regression[const.DATA_LENGTH+2][1]=''
        # data_mark_regression[const.DATA_LENGTH+2][2]=round((data_mark_regression[const.DATA_LENGTH+1][2]/sum_value)*100,2)
        ...
        # label_plot = ctk.CTkLabel(master=frame_plot,text='Оценка качества регрессионной модели',font=('Arial',20))
        #-----------------------------PLOTTING-----------------------------------#
        ...
        # frame_init_data_table.pack(anchor='w',padx=5,pady=5)
        # frame_plot.pack(anchor='e',padx=5,pady=5)
