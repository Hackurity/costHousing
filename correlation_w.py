...
class correlation_view(ctk.CTkToplevel):
    def __init__(self):
        ...
        # # control_frame = ctk.CTkFrame(master=self, width=self.winfo_width(),height=100)

        # pair_correl_btn = ctk.CTkButton(master = control_frame,text='м. парн.корр.',font=('Arial',13))
        # pair_correl_stud_btn = ctk.CTkButton(master = control_frame,text='Стьюдент для парн. корр.',font=('Arial',13))
        # pair_personal_btn = ctk.CTkButton(master = control_frame,text='м. част.корр.',font=('Arial',13))
        # pair_personal_stud_btn = ctk.CTkButton(master = control_frame,text='Стьюдент для част. корр.',font=('Arial',13))
        # pair_plead_btn = ctk.CTkButton(master = control_frame,text='Плеяда для парн.',font=('Arial',13))
        # personal_plead_btn = ctk.CTkButton(master = control_frame,text='Плеяда для част.',font=('Arial',13))

        # pair_correl_btn.grid(column=0,row=0, padx=5,pady=5)
        # pair_correl_stud_btn.grid(column=1,row=0, padx=5,pady=5)
        # pair_personal_btn.grid(column=2,row=0, padx=5,pady=5)
        # pair_personal_stud_btn.grid(column=0,row=1, padx=5,pady=5)
        # pair_plead_btn.grid(column=1,row=1, padx=5,pady=5)
        # personal_plead_btn.grid(column=2,row=1, padx=5,pady=5)
        ...
        #step_matrix = 0
        #get correl koefs (Pirson koef of pair correl)
        ...
        # clear_btn.grid(column=3,row=1, padx=5,pady=5,sticky='e')
        #---------------------------------CONTROL_FRAME------------------------------------------#
